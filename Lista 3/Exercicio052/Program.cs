...
public class Pessoa
{
    ...
    public virtual void ExecutarRotinaDiaria()
    {
        Console.WriteLine($"[{_nome}] Acorda e toma café da manhã.");
    }
...
public class Funcionario : Pessoa
{
    ...
    {
        base.Apresentar();
        Console.WriteLine($"Trabalho como {_cargo} e recebo {_salario:C2}.");
    }

    public override void ExecutarRotinaDiaria()
    {
        base.ExecutarRotinaDiaria();
        Console.WriteLine($"[{_nome}] Bate ponto e executa tarefas do cargo de {_cargo}.");
    }
...
public class Gerente : Funcionario
{
    ...
    {
        base.Apresentar();
        Console.WriteLine($"Gerencio equipes e recebo um bônus adicional de {_bonus:C2}.");
    }

    public override void ExecutarRotinaDiaria()
    {
        base.ExecutarRotinaDiaria();
        Console.WriteLine($"[{_nome}] Conduz reuniões de alinhamento e gerencia entregas do time.");
    }

    public override string ToString() =>
        $"Gerente: {_nome} | Bônus: {_bonus:C2}";
}
