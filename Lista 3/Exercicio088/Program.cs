...
class Program
{
    static void Main()
    {
        ...
        {
            new PagamentoPix("PIX-001", 250.00m, "contato@empresa.com"),
            new PagamentoCartao("CC-002", 1500.00m, "1234567890123456", 5),
            new PagamentoPix("PIX-003", 89.90m, "44999998888")
        };
        ...
        foreach (IPagamento pagamento in listaPagamentos)
        {
            ...
            Console.WriteLine($" Processado: {sucesso}");
