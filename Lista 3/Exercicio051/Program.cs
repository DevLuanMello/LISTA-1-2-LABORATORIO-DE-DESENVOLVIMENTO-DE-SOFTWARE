...
public class Pessoa
{
    ...
    {
        Console.WriteLine($"[{_nome}] Acorda, toma café da manhã e se prepara para o dia.");
    }
...
public class Funcionario : Pessoa
{
    ...
    public override void ExecutarRotinaDiaria()
    {
        ...
        Console.WriteLine($"[{_nome}] Trabalha no cargo de {_cargo} batendo ponto no horário.");
    }
...
public class Gerente : Funcionario
{
    ...
    {
        base.ExecutarRotinaDiaria();
        Console.WriteLine($"[{_nome}] Reúne a equipe para alinhamento de metas e analisa indicadores.");
    }
