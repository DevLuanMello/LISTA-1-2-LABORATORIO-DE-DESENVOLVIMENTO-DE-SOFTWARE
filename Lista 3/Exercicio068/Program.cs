...
public abstract class Funcionario
{
    ...
    public abstract decimal CalcularBonificacao();

    public virtual void ExibirHolerite()
    {
        Console.WriteLine($"Cargo: {Cargo,-15} | Nome: {Nome,-10} | Salário Total: R$ {CalcularSalario():F2} | Bônus: R$ {CalcularBonificacao():F2}");
    }
}
...
public class Gerente : Funcionario
{
    ...
    public override decimal CalcularBonificacao() => _salarioBase * 0.20m + _bonusGerencial;
...
public class Desenvolvedor : Funcionario
{
    ...
    public override decimal CalcularBonificacao() => _salarioBase * 0.10m;
